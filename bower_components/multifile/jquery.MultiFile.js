...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'No puede seleccionar un archivo $ext.\nIntentelo nuevamente...',
			file: '$file',
			selected: 'Archivo seleccionado: $file',
			duplicate: 'Este archivo ya ha sido seleccionado:\n$file',
			toomuch: 'Los archivos exceden el tamaño maximo permitido ($size)',
			toomany: 'Ha seleccionado demasiado archivos (max: $max)',
			toobig: '$file es demasiado grande (max $size)'
		},
