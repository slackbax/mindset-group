		...
		$.extend(Plugin.prototype, {
				...
				buildInputBoxes: function () {
					...
					if(this.settings.hidedigits){
							...
							this._pwfield = $('<input>').attr({'type':'password','pattern': "[a-z0-9]*", 'inputmode':"text",'id':'preventautofill','autocomplete':'off'}).appendTo(this._pwcontainer);
					...
					if(this._isTouchDevice()){
						...
						var input = $('<input>').attr({'type':'number','pattern': "[a-z0-9]*", 'placeholder':touchplaceholders, 'inputmode':"text",'maxlength':this.settings.inputs,'autocomplete':'off'}).addClass('form-control pincode-input-text').appendTo(wrapper);
	        		...
	        		input.on('keydown', $.proxy(function(e){
							...
							if(this._isTouchDevice()){
								...
								if( !(e.keyCode == 8                                // backspace key
										...
										|| (e.keyCode >= 65 && e.keyCode <= 90)     // caps off letters
