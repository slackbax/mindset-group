...
<?php $us = new User() ?>
<?php $g = $gr->get($id) ?>
<?php $users = $us->getByGroup($id) ?>

<section class="content-header">
    <h1>Administración
        <small>Edición de grupos</small>
    </h1>

    <ol class="breadcrumb">
        <li><a href="index.php?section=home"><i class="fa fa-home"></i> Inicio</a></li>
        <li class="active">Edición de grupos</li>
    </ol>
</section>
    ...
    <form role="form" id="formNewGroup">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-sm-6 col-lg-4 has-feedback" id="gname">
                        ...
                        <input type="text" class="form-control" id="iNname" name="iname" placeholder="Ingresa nombre del grupo" required value="<?php echo $g->gr_nombre ?>">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="inuser" id="iNnuser" value="<?php echo count($users) ?>">
                ...
                <div id="divUsers" style="padding: 2px 10px; margin-bottom: 10px; background-color: #f2f2f2; border: 2px solid #f2f2f2">
                    ...
                    <div id="divUsers-inner">
                        ...
                        <?php foreach ($users as $k => $v): ?>
                            <div class="row" id="row<?php echo $n_user ?>">
                                <div class="form-group col-xs-10 col-lg-11">
                                    <p class="form-control-static"><?php echo $v->us_nombres . ' ' . $v->us_ap . ' ' . $v->us_am ?></p>
                                </div>
                                <div class="form-group col-xs-2 col-lg-1 text-center">
                                    <button type="button" class="btn btn-xs btn-danger btnDel" name="btn_<?php echo $n_user ?>" id="btndel_<?php echo $n_user ?>"><i class="fa fa-close"></i></button>
                                </div>
                                <input type="hidden" class="iusr" name="ius[]" id="iNus_<?php echo $n_user ?>" value="<?php echo $v->us_id ?>">
                            </div>
                            <?php $n_user++ ?>
                        <?php endforeach ?>
                    </div>
